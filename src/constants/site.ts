...
export const COMPANY_NAME = "Threemates Tech Venture";
...
export const COMPANY_SUMMARY =
  `${COMPANY_NAME} builds ERP systems, SaaS products, web platforms, mobile apps, and AI skilling programs for institutions and growth-stage businesses.`;
